...
<template>
  <section class="py-4 lg:py-4 antialiased">
    <div class="max-w-2xl mx-auto px-4">
      ...
      <form class="mb-6">
        <div
          class="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg
                        border border-gray-200 dark:bg-gray-600 dark:border-gray-700"
        >
          <label
            for="comment"
            class="sr-only"
          ...
          <textarea
            ...
            class="px-0 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none
                            dark:text-white dark:placeholder-gray-400 dark:bg-gray-600"
